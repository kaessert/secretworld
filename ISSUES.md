...
5. ✅ Create initial scenarios for core features (23 YAML scenarios in scripts/scenarios/: character_creation (5), movement (3), combat (7), inventory (2), NPC (3), exploration (1), rest (1), crafting (1); validated by tests/test_scenario_files.py)
...
- [x] Initial YAML scenarios for core features created and validated (Phase 3 Step 5 - 23 scenarios COMPLETE)
...
- `scripts/scenarios/` - YAML validation scenarios (23 files organized by feature, including vertical_navigation.yaml, basic_crafting.yaml, and quest_accept.yaml)
