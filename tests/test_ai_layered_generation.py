...
class TestGenerateLocationWithContext:
    ...
    def test_returns_valid_structure(
        ...
        valid_response = {
            ...
            "connections": {"south": "Village Gate"},
            "category": "forest",
        }
        ...
        # Verify structure - should have location fields but no NPCs
    ...
    def test_uses_minimal_prompt_template(
        ...
        assert "east" in prompt  # direction
        assert "Old Mill" in prompt  # source_location
